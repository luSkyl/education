...
public class HlsVideoUtil extends VideoUtil {
    ...
    public HlsVideoUtil(String ffmpegPath, String videoPath, String m3u8Name, String m3u8folderPath) {
        super(ffmpegPath);
        this.ffmpegPath = ffmpegPath;
        this.videoPath = videoPath;
        this.m3u8Name = m3u8Name;
        this.m3u8folderPath = m3u8folderPath;
    }
...
//        String m3u8_name = video_name.substring(0, video_name.lastIndexOf("."))+".m3u8";
        ...
        commend.add(m3u8folderPath + m3u8Name.substring(0, m3u8Name.lastIndexOf(".")) + "_%05d.ts");
        commend.add(m3u8folderPath + m3u8Name);
        ...
        //通过查看视频时长判断是否成功
        Boolean check_video_time = check_video_time(videoPath, m3u8folderPath + m3u8Name);
        if (!check_video_time) {
            return outstring;
        }
        //通过查看m3u8列表判断是否成功
        List<String> ts_list = getTsList();
        if (ts_list == null) {
            return outstring;
        }
        return "success";
...
//        String m3u8_name = video_name.substring(0, video_name.lastIndexOf("."))+".m3u8";
        ...
        String m3u8file_path = m3u8folderPath + m3u8Name;
...
//            fileList.add(hls_relativepath+m3u8_name);
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println(videoUtil.getTsList());
    }
}
